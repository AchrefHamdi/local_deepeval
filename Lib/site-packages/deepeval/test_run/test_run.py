...
class TestRunManager:
    ...
    @staticmethod
    def display_temp_test_run_data(data):
        print(json.dumps(data, indent=4))

    # @staticmethod
    # def save_temp_test_run_data_to_file(data):
    #     temp_file_name = "temp_test_run_data.json"
    #     with open(temp_file_name, "w") as file:
    #         json.dump(data, file, indent=4)
    #     print(f"Test run data saved to file: {temp_file_name}")
    @staticmethod
    def save_temp_test_run_data_to_file(data):
        ...
        absolute_path = split[0]+"\\"+split[1]
        directory = "Trace_Deepeval_llamaindex\Exercices"
        temp_file_name = os.path.join(absolute_path,directory, "temp_test_run_data.json")
        with open(temp_file_name, "w") as file:
            json.dump(data, file)
        ...
        if self.save_to_disk:
            try:
                with portalocker.Lock(
                    ...
                    print("Test run loaded successfully:")
                    #self.display_temp_test_run_data(self.test_run.dict())  # Display content
                    self.save_temp_test_run_data_to_file(self.test_run.dict())  # Save content to file
            except (
                FileNotFoundError,
